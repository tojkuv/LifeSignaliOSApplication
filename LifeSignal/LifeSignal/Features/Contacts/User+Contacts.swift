...
extension User {
    ...
    private var _contacts: [ContactReference]?
    
    /// Flag indicating if user has manually triggered an alert
    var manualAlertActive: Bool {
        get { _manualAlertActive ?? false }
        set { _manualAlertActive = newValue }
    }
    private var _manualAlertActive: Bool?
    
    /// Timestamp when user manually triggered an alert
    var manualAlertTimestamp: Date? {
        get { _manualAlertTimestamp }
        set { _manualAlertTimestamp = newValue }
    }
    private var _manualAlertTimestamp: Date?
