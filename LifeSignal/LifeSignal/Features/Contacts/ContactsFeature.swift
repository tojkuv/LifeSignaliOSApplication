...
struct Contact: Identifiable, Equatable, Codable {
    ...
    init(
        ...
        self.lastCheckIn = lastCheckedIn
        self.interval = checkInInterval
    ...
    func toFirestoreData() -> [String: Any] {
        ...
        data[FirestoreConstants.ContactFields.phone] = phone
        ...
        data[FirestoreConstants.ContactFields.addedAt] = Timestamp(date: addedAt)

        if let lastCheckIn = lastCheckIn {
            data[FirestoreConstants.ContactFields.lastCheckIn] = Timestamp(date: lastCheckIn)
        }

        if let interval = interval {
            data[FirestoreConstants.ContactFields.interval] = interval
        }
    ...
    static func fromFirestore(_ data: [String: Any], contactId: String) -> Contact? {
        ...
        contact.phone = data[FirestoreConstants.ContactFields.phone] as? String ?? ""
        ...
        if let lastCheckIn = data[FirestoreConstants.ContactFields.lastCheckIn] as? Timestamp {
            contact.lastCheckIn = lastCheckIn.dateValue()
        }

        if let interval = data[FirestoreConstants.ContactFields.interval] as? TimeInterval {
            contact.interval = interval
        }
