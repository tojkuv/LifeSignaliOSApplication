...
class AuthenticationViewModel: BaseViewModel {
    ...
    func sendVerificationCode(completion: ((Bool, Error?) -> Void)? = nil) {
        ...
        AuthenticationService.shared.sendVerificationCode(to: formattedPhoneNumber) { [weak self] verificationID, error in
    ...
    func verifyCode(isAuthenticated: Binding<Bool>, needsOnboarding: Binding<Bool>, completion: ((Bool, Error?) -> Void)? = nil) {
        ...
        // Verify the code
        AuthenticationService.shared.verifyCode(verificationCode, verificationID: verificationID) { [weak self] authResult, error in
            guard let self = self else { return }
