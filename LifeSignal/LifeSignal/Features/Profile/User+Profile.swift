...
extension User {
    ...
    func toFirestoreData() -> [String: Any] {
        var data: [String: Any] = [
            ...
            User.Fields.checkInInterval: checkInInterval,
    ...
    static func fromFirestore(_ data: [String: Any], id: String) -> User? {
        ...
        user.fcmToken = data[User.Fields.fcmToken] as? String
        user.sessionId = data[User.Fields.sessionId] as? String
        ...
        user.notify30MinBefore = data[User.Fields.notify30MinBefore] as? Bool ?? true
        user.notify2HoursBefore = data[User.Fields.notify2HoursBefore] as? Bool ?? true
        ...
        user.manualAlertActive = data[User.Fields.manualAlertActive] as? Bool ?? false
