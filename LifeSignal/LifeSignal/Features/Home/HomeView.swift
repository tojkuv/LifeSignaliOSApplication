...
struct HomeView: View {
    ...
    private var notificationSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            let notificationBinding = Binding<Int>(
            ...
            Picker("Check-in notification", selection: notificationBinding) {
                Text("30 mins").tag(30)
    ...
    private var alertToggleSection: some View {
        Button(action: {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showQRScanner, onDismiss: handleQRScannerDismiss) {
    ...
    private func handleQRScannerDismiss() {
    ...
    private func handleAddContact(confirmedContact: ContactReference) {
    ...
    private func handleIntervalUpdate(newInterval: TimeInterval, completion: @escaping (Bool, Error?) -> Void) {
        // Create data to update in Firestore
        let updateData: [String: Any] = [
            User.Fields.checkInInterval: newInterval,
